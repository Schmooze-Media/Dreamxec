...
// ─── Alumni Badge ─────────────────────────────────────────────────────────────
const AlumniBadge: React.FC = () => (
  <div
    className="flex items-center gap-4 p-5"
    style={{
      background: "#f0fdf4",
      border: "4px solid #0B9C2C",
      boxShadow: "6px 6px 0 #003366",
    }}
  >
    {/* Left icon */}
    <div
    ...
    <div className="flex-1">
      <div className="flex items-center gap-2 mb-1">
        <p className="font-black text-base text-[#003366] uppercase tracking-wide">
          Alumni Check ✓
        </p>
        <span
      ...
      <p className="text-sm font-medium text-[#003366]/70">
        You have successfully unlocked our new Alumni feature. Welcome to the
        DreamXec Alumni network — thank you for supporting student innovation!
      </p>
    </div>

    {/* Right tag */}
    <div
      className="hidden sm:flex flex-col items-center justify-center px-4 py-3 flex-shrink-0"
      style={{
        background: "#003366",
        border: "2px solid #0B9C2C",
      }}
    >
      <span className="text-[10px] font-black uppercase tracking-widest text-[#0B9C2C]">
        DreamXec
      </span>
    ...
    >
      ...
      >
        ...
        <div
          ...
          style={{ borderBottom: "3px solid #FF7F00" }}
        >
          <div
          ...
          <div>
            <p className="font-black text-base text-white uppercase tracking-widest leading-none">
              DreamXec
            </p>
        ...
        <div
          className="px-5 py-5"
          style={{ borderBottom: "3px solid rgba(255,127,0,0.35)" }}
        >
        ...
        <div className="flex-1 p-5 sm:p-6 lg:p-8 space-y-6">
          ...
          {selectedTab === "overview" && (
            <>
              ...
              {/* Welcome + Tier */}
              <div
                className="flex flex-col md:flex-row md:items-center md:justify-between gap-4 p-5 bg-white"
                style={{
                  border: "3px solid #003366",
              ...
              >
                <div>
                  ...
                  <p className="text-xs font-bold text-[#003366]/50 uppercase tracking-widest ml-4">
                    Research Karega India, Toh aage Badhega India
                  </p>
                </div>
                ...
                >
                  <div className="flex items-center justify-between mb-3">
                    ...
                    <span className="text-xs font-black text-[#003366] uppercase tracking-widest">
                      {eligibility.createdProjects} /{" "}
                      {eligibility.allowedProjects} used &nbsp;·&nbsp;{" "}
                      {eligibility.remainingProjects} remaining
                    </span>
                  </div>
                  <div
                  ...
                  {!eligibility.canCreateOpportunity && (
                    <p className="mt-2 text-xs font-black text-red-600 uppercase tracking-wide">
                      Donate {formatCurrency(eligibility.perProjectCost)} more
              ...
              {loadingDonations ? (
                ...
                >
                  <p className="text-sm font-bold text-[#003366]/60">
                    Make your first donation to see your stats here 💝
                  </p>
                </div>
              ) : (
                <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                  ...
                  <KpiCard
                    icon="🏆"
                    title="Biggest Gift"
                    value={formatCurrency(maxDonation)}
                    accent="#003366"
                  />
                  <KpiCard
                    icon=""
              ...
              {!loadingDonations && myDonations.length > 0 && (
                ...
                >
                  ...
                  <p className="text-[10px] font-bold text-orange-300 uppercase tracking-widest mb-5 ml-4">
                    Impact Score = Total donated + (campaigns × 500) +
                    (donations × 50)
                  </p>
                  <div className="grid md:grid-cols-3 gap-4">
                    {[
                      ...
                      },
                      {
                        ...
                        value: `${projectsSupported} Projects`,
                      },
                    ].map(({ label, value }) => (
                      <div
                        key={label}
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                >
                  ...
                  <div>
                    <p className="font-black text-base text-[#003366] uppercase tracking-tight">
                      Create New Project
                    </p>
                    <p className="text-xs font-medium text-[#003366]/60 mt-1">
                ...
                >
                  ...
                  <div>
                    ...
                    <p className="text-xs font-medium text-[#003366]/60 mt-1">
                      Manage existing projects and applications
                    </p>
                  </div>
                </button>
              </div>
              ...
              {loadingApplications ? (
                ...
                <>
                  {paginatedApps.map((app) => (
                    <div
                      key={app.id}
                      className="bg-white p-6 transition-all duration-150 hover:translate-x-[-2px] hover:translate-y-[-2px]"
                      style={{
                        border: "3px solid #003366",
                        boxShadow: "6px 6px 0 #FF7F00",
                      }}
                    >
                      ...
                      <div className="flex flex-col md:flex-row md:items-start md:justify-between gap-4 mb-5">
                        <div className="flex items-center gap-3">
                          ...
                          <div>
                            <h3 className="font-black text-base text-[#003366] uppercase tracking-tight">
                              {app.user?.name || "Student"}
                            </h3>
                            <p className="text-xs font-bold text-[#003366]/50">
                              {app.user?.email}
                            </p>
                          </div>
                        </div>
                      ...
                      >
                        <p className="text-[10px] font-black uppercase tracking-widest text-[#003366]/40 mb-1">
                          Applied For
                        </p>
                        <p className="font-black text-sm text-[#003366] uppercase tracking-tight">
                          {app.donorProject?.title || "Project"}
                        </p>
                        {app.donorProject?.organization && (
                          <p className="text-xs font-bold text-[#003366]/50 mt-0.5">
                            {app.donorProject.organization}
                          </p>
                        )}
                      </div>
                      ...
                      {/* Cover letter */}
                      <div className="mb-4">
                        <p className="text-[10px] font-black uppercase tracking-widest text-[#003366]/50 mb-2">
                          Cover Letter
                        </p>
                        <p
                          className="text-sm font-medium text-[#003366] leading-relaxed px-4 py-3 line-clamp-4"
                          style={{
                            background: "#fffbf5",
                            border: "2px solid #003366",
                          }}
                      ...
                      {app.skills && app.skills.length > 0 && (
                        <div className="mb-4 flex flex-wrap gap-1.5">
                          {app.skills.map((skill, idx) => (
                            <span
                              key={idx}
                              className="px-2.5 py-1 text-[10px] font-black uppercase tracking-wide"
                              style={{
                                background: "#f0fdf4",
                                color: "#166534",
                                border: "2px solid #0B9C2C",
                      ...
                      <p className="text-[10px] font-bold text-[#003366]/40 uppercase tracking-widest mb-4">
                      ...
                      {app.status === "PENDING" && (
                        <div className="flex gap-3">
                          ...
                          >
                            <Ico name="check-circle" className="w-4 h-4" />{" "}
                            Accept
                          </button>
                          <button
                            onClick={() =>
          ...
          {selectedTab === "projects" && (
            <EmptyState
              ...
              action={
                <button
                  onClick={onViewProjects}
                  className="px-6 py-3 text-xs font-black uppercase tracking-widest text-white transition-all hover:translate-x-[-2px] hover:translate-y-[-2px]"
                  style={{
                    background: "#FF7F00",
                    color: "#003366",
                    border: "3px solid #003366",
          ...
          {selectedTab === "donations" && (
            <div className="space-y-6">
              ...
              {/* Filters & actions */}
              <div
                className="flex flex-wrap gap-3 items-center p-4 bg-white"
                style={{
                  border: "3px solid #003366",
              ...
              {loadingDonations ? (
                ...
                <EmptyState
                  ...
                  description={
                    filterAmount > 0
                      ? `No donations above ${formatCurrency(filterAmount)}.`
                ...
                <>
                  {paginatedDonations.map((d) => (
                    <div
                      key={d.id}
                      className="bg-white p-5 flex items-start justify-between gap-4 transition-all duration-150 hover:translate-x-[-2px] hover:translate-y-[-2px]"
                      style={{
                        border: "3px solid #003366",
                    ...
                    >
                      <div className="flex-1 min-w-0">
                        <p className="font-black text-base text-[#003366] uppercase tracking-tight truncate">
                          {d.userProject?.title}
                        </p>
                        <p className="text-[10px] font-bold text-[#003366]/50 uppercase tracking-widest mt-1">
                          {formatDate(d.createdAt)}
                        </p>
                        {d.message && (
                          <p className="italic text-sm font-medium text-[#003366]/70 mt-2 line-clamp-2">
                            "{d.message}"
                          </p>
                        )}
                      </div>
                      ...
                      >
                        <p className="font-black text-xl text-[#166534]">
          ...
          {selectedTab === "wishlist" && (
            <div className="space-y-6">
              {wishlistError && (
                <ErrorBanner message={wishlistError} onRetry={loadWishlist} />
              )}
              {loadingWishlist ? (
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                  {wishlist.map((campaign, idx) => {
                    ...
                    const progress = Math.min(
                      ((campaign.amountRaised || 0) / campaign.goalAmount) *
                        100,
                      100,
                    );
                    return (
                      ...
                      >
                        ...
                        >
                          {campaign.imageUrl ? (
                            ...
                            >
                              <div
                                className="absolute -top-3 -right-3 w-16 h-16 rotate-12 opacity-20"
                                style={{
                                  background: accent,
                                  border: "3px solid #fff",
                                }}
                              />
                              <p
                                className="font-black text-white uppercase text-center leading-tight"
                                style={{
                                  fontSize:
                          ...
                          {/* Status badge */}
                          <div
                            className="absolute top-2 right-2 px-2.5 py-1 text-[10px] font-black uppercase tracking-widest text-white"
                            style={{
                              background: "#FF7F00",
                              border: "2px solid #003366",
                            }}
                        ...
                        <div className="p-4 flex flex-col flex-1">
                          <h3 className="font-black text-sm text-[#003366] uppercase tracking-tight mb-1 truncate">
                            {campaign.title}
                          </h3>
                          <p className="text-xs font-medium text-[#003366]/60 mb-4 line-clamp-2">
                          ...
                          <div className="mb-4 mt-auto">
                            <div className="flex justify-between mb-1">
                              ...
                              <span className="text-[10px] font-bold text-[#003366]/50">
